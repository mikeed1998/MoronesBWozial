...
<div class="d-flex align-items-center container-fluid p-5" style="background-image: url({{asset("img/design/img_9.png")}}); padding-top: 100px; height: 550px;">
	<div class="row">
		<div class="col-md-5" style="text-align: right;">
			<img class="hide_hombre" src="{{asset("img/design/hombre.png")}}">
		</div>
		<div class="col-md-5 col-12 pt-5 servicios">
			<h2 class="resp_title" style="font-size: 50px; font-weight: lighter; color: white;">Consultoria en TI.</h2>
			<p style="font-weight: lighter; color: white;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's. 
...
<div class="container-fluid" style="background-color: black;">
	<div class="row">
		...
		<div class="col-md-9 col-12 pt-5">
			<h2 style="font-size: 50px; font-weight: lighter; color: white;">Consultoria en TI.</h2>
		</div>
		<div class="col-2"></div>
		<div class="col-1"></div>
		<div class="col-md-9 col-12">
			<p style="font-weight: lighter; color: white;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
		...
		<div class="col-1"></div>
		<div class="col-md-9 col-12">
			<h2 style="font-size: 50px; font-weight: lighter; color: white;">Dirigido a:</h2>
		</div>
		<div class="col-2"></div>
		<div class="col-1"></div>
		<div class="col-md-9 col-12">
		...
		<div class="col-2"></div>
		<div class="col-1"></div>
		<div class="col-md-9 col-12" style="padding-bottom: 50px">
      <a href="#" class="btn btn-primary align-items-end btn_gde pt-2">agendar</a>            
		</div>
		<div class="col-2"></div>
	</div>
</div>
...
<div class="container-fluid my-5">
	<div class="row">
	  <div class="col-12">
		<h3 style="text-align: center; font-size: 40px; font-weight: lighter;">Software de apoyo</h3>
	  </div>
	  <div class="col-3"></div>
	  <div class="col-6">
		<p style="text-align: center; color: rgb(199, 199, 199);">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
		  standard dummy text ever since the 1500s.</p>
	  </div>
	  <div class="col-3"></div>
	  <div class="col-2"></div>
	  <div class="col-8" style="text-align: center;">
		<img src="{{asset("img/design/icon_1.png")}}" style="height: 90px; align-self: center; margin: 10px;">
		<img src="{{asset("img/design/icon_2.png")}}" style="height: 90px; align-self: center; margin: 10px;">
		<img src="{{asset("img/design/icon_3.png")}}" style="height: 90px; align-self: center; margin: 10px;">
		<img src="{{asset("img/design/icon_4.png")}}" style="height: 90px; align-self: center; margin: 10px;">
	  </div>
	  <div class="col-1"></div>
	</div>
  </div>
                    ...
                    <div class="Cont-Cads-Vac-Sec3">
                        ...
                        <div>
                            <div class="Cont-Button-Cards-sec3">
                                <a target="_blank" href="https://wa.me/52{{$config->whatsapp}}?text=Hola! estoy interesado en la vacante de {{$vac->titulo}}"><button>APLICAR</button></a>
                            </div>
                        </div>
                    </div>
